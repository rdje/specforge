...
- current tracked fixtures cover blocked heuristic leakage, weaker alias-dependent semantics that must stay explicitly caveated, both positive and negative cross-modality grounding behavior, and both positive and negative direct VLM timing-note semantic grounding
