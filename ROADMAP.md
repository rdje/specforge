...
oracle and `.9b`/`.9c` re-ingested the APB and AHB golds, so 26 chains are re-derivable and 52 stay legacy (the
AXI gold among them); re-derivation retired the SWD `29/29` (`.8c`) and APB's temporal `1.000` (`.9b`).
