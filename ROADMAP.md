...
- done:
  ...
  - fixture expectations can now assert canonical state names and transition endpoints directly, so VLM state-machine truthfulness can be locked without generated-artifact spelunking
