...
- completion criteria:
  ...
  - parametric public top-port blockers preserve top-boundary width resolution guidance and composition-topology residual diagnostics on blocked top and aggregate `.fsm` renderability surfaces
