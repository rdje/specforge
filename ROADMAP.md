...
- done:
  ...
  - the initial fixture pack includes:
    ...
    - a negative fixture proving relative-clause actor noise such as `mixture of` does not become a protocol actor, while coordinated active-drive objects like `ARCHUNKEN and RCHUNKV` both keep the real head actor
