...
- remaining:
  - expand from the current AMBA + APB + AHB + early AXI gold paths to a broader AXI-focused suite plus richer remaining AHB timing and structured-constraint fixtures
