...
- completion criteria:
  ...
  - single FSM-child top-composition lowering preserves child support IDs while preserving FSM child root kind
  - renderable top-before-child source-document emission preserves child support IDs while keeping top-first output order
