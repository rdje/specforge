...
- done:
  ...
  - fixture expectations can now assert EvidenceIR table-signal provenance directly via `table_signal_declaration_provenance_include`, so table-authority fixtures prove table-synthesized declarations point at the intended structured table and generated statement text before canonical carry-through
