...
- completion criteria:
  ...
  - duplicate top child-instance blockers preserve child-instance deduplication guidance alongside both duplicate child declaration support-ID sets
  ...
  - top links originating from undeclared top-boundary ports preserve source-endpoint enrichment guidance while retaining top-port, child, and link provenance
  - top links originating from child endpoints absent from emitted child modules preserve source-endpoint enrichment guidance while retaining top-port, child, and link provenance
  - top links targeting child endpoints absent from emitted child modules preserve target-endpoint enrichment guidance while retaining top-port, child, and link provenance
  ...
  - top child-link width conflict blockers preserve top-boundary width-conflict enrichment guidance on blocked top and aggregate `.fsm` renderability surfaces
