...
- remaining:
  - connect visual-motif corroboration guidance to future explicit VLM enrichment/rescan command hints rather than only generic evidence rebuild/validation hints
