...
- remaining:
  - keep expanding from the current AMBA + APB + AHB + AXI write-address/write-response/read-address/read-data/write-data/sideband-stability gold paths to remaining structured-constraint fixtures
