...
- remaining:
  - keep expanding from the current AMBA + APB + AHB + AXI write-address/write-response/read-data/write-data gold paths to remaining AXI channel coverage plus structured-constraint fixtures
