...
oracle, so a wire score is re-derivable again over the 24 rebuildable chains while the 54 legacy chains — the
APB/AHB/AXI golds among them — stay unmeasurable; its first re-derivation retired the SWD `29/29` (`.8c`).
