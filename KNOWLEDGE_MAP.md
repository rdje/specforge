...
- "do the emergent clusters actually track real vendor/layout families" -> [corpus-cluster-fingerprint](docs/knowledge/corpus-cluster-fingerprint.md) · 2026-06-09 · reverify: `cargo test -p specforge --lib ir::corpus_cluster`
...
- "how does SpecForge cluster chip-spec PDFs by vendor/layout without hardcoding vendor names" -> [corpus-cluster-fingerprint](docs/knowledge/corpus-cluster-fingerprint.md) · 2026-06-09 · reverify: `cargo test -p specforge --lib ir::corpus_cluster`
...
- "what is corpus_cluster / document_fingerprint / cluster_documents / DocumentCluster" -> [corpus-cluster-fingerprint](docs/knowledge/corpus-cluster-fingerprint.md) · 2026-06-09 · reverify: `cargo test -p specforge --lib ir::corpus_cluster`
...
- "what is the per-document fingerprint made of (structural shape + extraction_manifest fired set)" -> [corpus-cluster-fingerprint](docs/knowledge/corpus-cluster-fingerprint.md) · 2026-06-09 · reverify: `cargo test -p specforge --lib ir::corpus_cluster`
...
- "why are the fired: behavioral features mostly empty in the clustering today" -> [corpus-cluster-fingerprint](docs/knowledge/corpus-cluster-fingerprint.md) · 2026-06-09 · reverify: `cargo test -p specforge --lib ir::corpus_cluster`
