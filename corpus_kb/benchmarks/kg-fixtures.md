...
| `actor_taxonomy_prior_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/actor_taxonomy_prior_protocol_family_mismatch_negative/fixture.json` |
...
| `negative_knowledge_prior_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/negative_knowledge_prior_protocol_family_mismatch_negative/fixture.json` |
...
| `semantic_modality_reliability_amba_generic_fallback_gold` | `pass` | `crates/specforge/test_data/kg_quality/semantic_modality_reliability_amba_generic_fallback_gold/fixture.json` |
...
| `semantic_modality_reliability_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/semantic_modality_reliability_protocol_family_mismatch_negative/fixture.json` |
...
| `semantic_prior_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/semantic_prior_protocol_family_mismatch_negative/fixture.json` |
...
| `table_shape_prior_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/table_shape_prior_protocol_family_mismatch_negative/fixture.json` |
...
| `temporal_prior_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/temporal_prior_protocol_family_mismatch_negative/fixture.json` |
...
| `visual_motif_prior_protocol_family_mismatch_negative` | `pass` | `crates/specforge/test_data/kg_quality/visual_motif_prior_protocol_family_mismatch_negative/fixture.json` |
