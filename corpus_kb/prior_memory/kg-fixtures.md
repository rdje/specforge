# Typed Prior-Memory Fixture Patterns

This page records typed prior-memory KG fixture coverage from the tracked truthfulness benchmark suite.
It is derived from tracked KG fixture outcomes and remains reviewable synthesis, not canonical document truth.

## Human Synthesis

Use this section for curated notes about prior-guided gold/negative pairs, caution-only negative knowledge, local-grounding boundaries, and future CorpusMemory benchmark gaps.
...
- selected_structural_capabilities: `typed prior memory`
- fixtures_total: `30`
- fixtures_passed: `30`
- fixtures_failed: `0`
...
| --- | --- | --- | --- |
| `actor_taxonomy_prior_guided_section_direction_gold` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/actor_taxonomy_prior_guided_section_direction_gold/fixture.json` |
| `actor_taxonomy_prior_term_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/actor_taxonomy_prior_term_mismatch_negative/fixture.json` |
...
| `semantic_prior_broad_phrase_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/semantic_prior_broad_phrase_negative/fixture.json` |
| `semantic_prior_conflicting_roles_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/semantic_prior_conflicting_roles_negative/fixture.json` |
...
| `semantic_prior_normalized_phrase_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/semantic_prior_normalized_phrase_mismatch_negative/fixture.json` |
| `semantic_prior_phrase_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/semantic_prior_phrase_mismatch_negative/fixture.json` |
| `semantic_prior_source_kind_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/semantic_prior_source_kind_mismatch_negative/fixture.json` |
...
| `table_shape_prior_guided_timing_table_gold` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/table_shape_prior_guided_timing_table_gold/fixture.json` |
| `table_shape_prior_header_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/table_shape_prior_header_mismatch_negative/fixture.json` |
| `temporal_prior_guided_cycle_window_gold` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/temporal_prior_guided_cycle_window_gold/fixture.json` |
| `temporal_prior_phrase_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/temporal_prior_phrase_mismatch_negative/fixture.json` |
| `visual_motif_prior_caption_mismatch_negative` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/visual_motif_prior_caption_mismatch_negative/fixture.json` |
| `visual_motif_prior_guided_diagram_classification_gold` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/visual_motif_prior_guided_diagram_classification_gold/fixture.json` |
| `visual_semantic_prior_guided_caption_gold` | `pass` | `typed prior memory` | `crates/specforge/test_data/kg_quality/visual_semantic_prior_guided_caption_gold/fixture.json` |
