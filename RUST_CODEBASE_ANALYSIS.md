...
- Added root_kind_decision to the final 5 standalone DT tests. All standalone DT tests now carry root_kind_decision — zero gaps.
...
- Next: top composition tests (21 tests, Top root kind).
