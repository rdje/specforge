...
- `specforge validate` now reports `with_table_support` for `SemanticIR` and `IntentIR`, making table-backed canonical signal coverage visible without replacing exact per-signal provenance checks
