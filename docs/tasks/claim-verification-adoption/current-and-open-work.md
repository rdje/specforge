# CLAIM-VERIFICATION-ADOPTION — current and open work

- Part ID: `current-and-open-work`
- State: `active`

<!-- claim-verification-task-source-region:open-population-node:start -->
...
<!-- claim-verification-task-source-region:open-population-node:end -->

<!-- claim-verification-task-source-region:current-frontier-table:start -->
## Current Frontier
...
<!-- claim-verification-task-source-region:current-frontier-table:end -->

<!-- claim-verification-task-source-region:open-questions-and-blockers:start -->
## Open Questions
