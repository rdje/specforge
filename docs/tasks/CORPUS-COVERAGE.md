...
- Status: `active` (`.0` build-out + `.1` stage-staleness validator done; `.2` current-binary refresh batch
  remains active with 37 completed documents and frontier ready to select `.2.38`; `.3`
...
- Frontier: select and own `CORPUS-COVERAGE.2.38` from the 19-document tail before changing another artifact.
