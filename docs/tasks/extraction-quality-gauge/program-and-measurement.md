# EXTRACTION-QUALITY-GAUGE — program and measurement

- Part ID: `program-and-measurement`
- State: `legacy`

<!-- extraction-quality-gauge-task-source-region:gauge-and-root-causes:start -->
...
<!-- extraction-quality-gauge-task-source-region:gauge-and-root-causes:end -->

<!-- extraction-quality-gauge-task-source-region:prototype-pivot-and-thesis:start -->
...
<!-- extraction-quality-gauge-task-source-region:prototype-pivot-and-thesis:end -->
