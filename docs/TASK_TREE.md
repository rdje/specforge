...
| `ROADMAP-TASKTREE-COVERAGE` | `active` | `R0` | `ROADMAP-TASKTREE-COVERAGE.5` (R1–R5 + R8–R13 + R15c–g done/owned; next the ROADMAP↔code↔mdBook alignment lock + close) — turn the WHOLE roadmap into owned, audited task-trees (user doctrine directive `2026-05-31`) | [docs/tasks/ROADMAP-TASKTREE-COVERAGE.md](docs/tasks/ROADMAP-TASKTREE-COVERAGE.md) |
