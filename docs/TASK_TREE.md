...
| `R16-MODULE-HARDENING` | `active` | `R16` | `R16-MODULE-HARDENING.3` (`.1` figure_region + `.2` audit/clean-gaps done; `.3` = deeper-construction gaps then close) | [docs/tasks/R16-MODULE-HARDENING.md](docs/tasks/R16-MODULE-HARDENING.md) |
