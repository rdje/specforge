...
| `R16-MODULE-HARDENING` | `active` | `R16` | assess remaining 6 R16 modules (`.1` `figure_region.rs` unit-test backfill done) | [docs/tasks/R16-MODULE-HARDENING.md](docs/tasks/R16-MODULE-HARDENING.md) |
