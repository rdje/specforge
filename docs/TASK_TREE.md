...
| `LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION` | `active` | bounded live docs, stable README, and same-volume project data | [open](tasks/LIVE-DOCUMENT-SIZE-CONTAINMENT-ADOPTION.md) |
