...
| `R16-INTENT-CAPTURE` | `active` | `R16` | `R16-INTENT-CAPTURE.2` (governance live; #1+#2+#3+#5 active or done; promote #4 `R16-WAVEFORM-CONTRACT-MINING` next) | [docs/tasks/R16-INTENT-CAPTURE.md](docs/tasks/R16-INTENT-CAPTURE.md) |
...
| `R16-MULTIMODAL-CONTRACT-FUSION` | `active` | `R16` | `R16-MULTIMODAL-CONTRACT-FUSION.2` (`.1` design done; implement typed `fusion` module + merge primitive) | [docs/tasks/R16-MULTIMODAL-CONTRACT-FUSION.md](docs/tasks/R16-MULTIMODAL-CONTRACT-FUSION.md) |
