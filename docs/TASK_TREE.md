...
| `CVE-PROSE-EXTRACTION` | `active` | `R16` | `CVE-PROSE-EXTRACTION.2` (typed surface + fold; `.1` design done) — wire the live prose→`ActorContract` extractor (Qwen via Ollama) into the dormant R16 constrained-verified surface | [docs/tasks/CVE-PROSE-EXTRACTION.md](docs/tasks/CVE-PROSE-EXTRACTION.md) |
