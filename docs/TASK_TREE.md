...
| `ROADMAP-TASKTREE-COVERAGE` | `active` | `R0` | `ROADMAP-TASKTREE-COVERAGE.3` (R1–R5 done; next R8–R13, then R15c–g, then the ROADMAP↔code↔mdBook alignment lock) — turn the WHOLE roadmap into owned, audited task-trees (user doctrine directive `2026-05-31`) | [docs/tasks/ROADMAP-TASKTREE-COVERAGE.md](docs/tasks/ROADMAP-TASKTREE-COVERAGE.md) |
