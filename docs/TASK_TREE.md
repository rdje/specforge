...
| `R16-WAVEFORM-CONTRACT-MINING` | `active` | `R16` | `R16-WAVEFORM-CONTRACT-MINING.4` (`.1`+`.2`+`.3` (`.3.1`+`.3.2`) done; `.4` = corpus FigureConformance baseline + negative fixtures + close tree) | [docs/tasks/R16-WAVEFORM-CONTRACT-MINING.md](docs/tasks/R16-WAVEFORM-CONTRACT-MINING.md) |
