...
| `R16-INTENT-CAPTURE` | `active` | `R16` | `R16-INTENT-CAPTURE.2` (governance live; all 6 R16 sub-trees active or done — #1/#2/#3/#5 closed, #4+#6 active) | [docs/tasks/R16-INTENT-CAPTURE.md](docs/tasks/R16-INTENT-CAPTURE.md) |
...
| `R16-WAVEFORM-CONTRACT-MINING` | `active` | `R16` | `R16-WAVEFORM-CONTRACT-MINING.2` (`.1` design done; implement typed `waveform` module + generalizer + verifier; `.3` extractor flagged for honest split) | [docs/tasks/R16-WAVEFORM-CONTRACT-MINING.md](docs/tasks/R16-WAVEFORM-CONTRACT-MINING.md) |
| `R16-CONSTRAINED-VERIFIED-EXTRACTION` | `active` | `R16` | `R16-CONSTRAINED-VERIFIED-EXTRACTION.2` (`.1` design done; derive JSON schema for `ActorContract` + adapter) | [docs/tasks/R16-CONSTRAINED-VERIFIED-EXTRACTION.md](docs/tasks/R16-CONSTRAINED-VERIFIED-EXTRACTION.md) |
