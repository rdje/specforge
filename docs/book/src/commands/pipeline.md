...
SystemVerilog, Verilog, and VHDL targets remain planned but not started; their target names are reserved by the CLI, but lowering those targets currently reports feature-not-yet-implemented behavior.
