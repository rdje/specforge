...
Malformed provider options, including repeated provider/model/classification flags, missing provider values, and unsupported args, are rejected before execution.
