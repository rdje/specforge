...
Replay source and artifact path arguments must be non-empty relative paths without `..` parent traversal; empty, absolute, or upward-traversing replay paths are rejected before execution.
