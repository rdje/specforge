...
The harness self-tests the missing canonical table-support diagnostic at both `SemanticIR` and `IntentIR`, so these failures identify the fixture, stage, signal-specific expectation field, missing table id, and actual support set.
