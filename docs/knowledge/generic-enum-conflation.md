...
**`.5.iv.a` LANDED (`2026-08-31`) — the header now SOURCES the name, and three `.5.iv` records were
corrected.** `derive_header_sourced_enum_name` (`ir/evidence.rs`) runs after both existing paths decline, so
