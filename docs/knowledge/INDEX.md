...
> 225 fact cards route through 5 title parts; find an id inside a range, then open that part.
...
| [0003](../knowledge-catalog/titles-0003.md) | 56 | `isf-value-width-operand-contract` | `relation-completeness-staleness-vs-absence` |
| [0004](../knowledge-catalog/titles-0004.md) | 56 | `repo-local-temp-docling-test-collision` | `value-binder-alphabetic-whole-word` |
| [0005](../knowledge-catalog/titles-0005.md) | 1 | `vlm-table-strategy` | `vlm-table-strategy` |
