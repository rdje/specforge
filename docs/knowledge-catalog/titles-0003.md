...
| [qualified-current-source-to-intent-result](../knowledge/qualified-current-source-to-intent-result.md) | 2026-08-12 | `current` | The b977 reviewed population replay is qualified but revision-bound |
