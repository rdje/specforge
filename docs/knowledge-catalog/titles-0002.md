...
| [current-claim-census-freeze](../knowledge/current-claim-census-freeze.md) | 2026-08-29 | `current` | The repaired current-claim census freezes exact authority units whose totals ordinary work moves |
