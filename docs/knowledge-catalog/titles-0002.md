...
| [first-reviewed-trajectory-snapshot](../knowledge/first-reviewed-trajectory-snapshot.md) | 2026-08-12 | `current` | The evidence-composed trajectory gates current-binary replay coverage and recommends task .6 |
