...
| [current-claim-census-freeze](../knowledge/current-claim-census-freeze.md) | 2026-08-15 | `current` | The repaired current-claim census freezes 56 exact authority units with no incomplete outer key |
