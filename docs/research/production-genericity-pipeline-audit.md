...
Symbolic dependencies propagate to a deterministic fixed point across 2,270 production functions and 11,902
...
at 11,355 branch/selection/decision sites unless the call topology proves membership in a registered universal
