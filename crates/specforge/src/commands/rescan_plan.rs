...
mod tests {
    ...
    fn rescan_plan_execute_report_tracks_validated_no_change_summary() -> Result<()> {
        ...
        assert_eq!(
            report.execution_summaries[0].promotion_status,
            RESCAN_PROMOTION_NOT_PROMOTED_NO_CHANGE
        );
    ...
    #[test]
    fn rescan_plan_parses_skip_source_enrich_provider_hint() -> Result<()> {
        let enrich = command_hint(
            "enrich_source_ir",
            vec![
                "enrich",
    ...
    fn rescan_plan_large_limit_keeps_all_pending_in_order() {
        ...
        assert_eq!(selected_pending_indices(&plan, 10, None), vec![0, 2, 3]);
    }
    ...
    #[test]
    fn rescan_plan_execution_status_treats_grade_only_delta_as_changed() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
    ...
    #[test]
    fn rescan_plan_execution_status_treats_grade_removal_as_changed() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
    ...
    #[test]
    fn rescan_plan_arbitration_treats_score_removal_as_neutral_review() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: None,
    ...
    #[test]
    fn rescan_plan_arbitration_treats_grade_only_changes_as_neutral_review() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
    ...
    #[test]
    fn rescan_plan_arbitration_treats_removed_findings_as_possible_improvement() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
            finding_count: 2,
            finding_ids: vec!["finding_removed".to_string(), "finding_shared".to_string()],
        };
        let after = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "bbb".to_string(),
        ...
        assert_eq!(delta.finding_count_delta, 0);
        assert!(delta.added_findings.is_empty());
        assert_eq!(delta.removed_findings, vec!["finding_removed".to_string()]);
        assert_eq!(
            arbitration_verdict(&delta),
            ARBITRATION_POSSIBLE_IMPROVEMENT_REVIEW_REQUIRED
        );
    ...
    #[test]
    fn rescan_plan_arbitration_treats_added_findings_as_regression() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
        ...
        let after = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "bbb".to_string(),
            finding_ids: vec!["finding_added".to_string(), "finding_shared".to_string()],
            ..before.clone()
        };
        ...
        assert_eq!(delta.score_delta, Some(0));
        assert_eq!(delta.finding_count_delta, 0);
        assert_eq!(delta.added_findings, vec!["finding_added".to_string()]);
        assert!(delta.removed_findings.is_empty());
        assert_eq!(
            arbitration_verdict(&delta),
            ARBITRATION_REGRESSION_REVIEW_REQUIRED
    ...
    #[test]
    fn rescan_plan_arbitration_treats_score_decrease_as_regression() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
        ...
        assert!(delta.score_changed);
        assert_eq!(delta.score_delta, Some(-5));
        assert_eq!(delta.finding_count_delta, 0);
        assert!(delta.added_findings.is_empty());
        assert!(delta.removed_findings.is_empty());
        assert_eq!(
    ...
    #[test]
    fn rescan_plan_arbitration_treats_score_increase_as_possible_improvement() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
    ...
    #[test]
    fn rescan_plan_arbitration_treats_finding_count_increase_as_regression() {
        let before = ProjectRescanValidationSnapshot {
            artifact_fingerprint: "aaa".to_string(),
            overall_score: Some(80),
            grade: Some("GOOD".to_string()),
