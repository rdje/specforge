...
mod tests {
    ...
    #[test]
    fn validate_intent_ir_does_not_flag_temporal_rules_missing_cycle_windows_for_named_quantified_edge_text()
    -> Result<()> {
        use crate::ir::evidence::EvidenceIr;
        use crate::ir::source::{SignalConstraintKind, SignalConstraintRecord};
    ...
    #[test]
    fn validate_intent_ir_does_not_flag_temporal_rules_missing_grounding_for_named_diagram_edge_text()
    -> Result<()> {
        use crate::ir::evidence::EvidenceIr;
        use crate::ir::source::{SignalConstraintKind, SignalConstraintRecord};
