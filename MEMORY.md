...
- **Characterise a difference before counting it** (`.11`: 73 tables / 527 declarations were a
  name-CASE change, not loss). **A control that fires and is explained validates a method; one waved
  through asserts it.**
