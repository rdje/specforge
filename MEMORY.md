...
2. teach visual-motif rescan hints to choose between local Ollama and local LM Studio from runtime readiness/model policy instead of always emitting Ollama
