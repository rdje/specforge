...
- the tracked live validation baseline has now been refreshed against the current semantic/intent stack and is lower but more honest than the old stale snapshot: AXI 79/100 GOOD, APB 84/100 GOOD, AHB 85/100 GOOD, AXI-Stream 90/100 EXCELLENT
...
2. decide whether the remaining `semantic_interface_grouping` residual should become a stronger canonical interface model or stay as explicit unresolved coupling
