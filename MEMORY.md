...
- completed_count: `.1`(`f557baba`) `.2`-split(`b92f29ef`) `.2.1`(`5be3b278`) IR-PRUNE.3-supersede(`3e3fe823`) `.2.2`(`0ccdc8f0` windowed temporal_rules→`(contract …)` live-verified) FSMGEN-ISSUE-REPORTING-tree(`1c3a5d37`) FSMGEN-ISSUE-REPORTING.1(`1b028453` F1 bundle built+reproduced, submodule clean) FSMGEN-ISSUE-REPORTING.2(`c415fc25` F2 stage bundle) FSMGEN-ISSUE-REPORTING.3(`a687cbd0` tree CLOSED) ISF-TEMPORAL-LOWERING.2.3(committing now: `classify_temporal_rule` Contract|Rule|Residual; guard `(== <declared-sig> <lit>)`/conditionless empirically strict-verified; live nvme 109→17 Rule/92 residual, strict `success:true`; 11 new tests). Next frontier: `ISF-TEMPORAL-LOWERING.2.4` (reconcile `transaction_count`/`rule_count` to emitted content + temporal residual count; still old blind formula)
