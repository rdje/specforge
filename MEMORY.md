...
- latest_commit: `<TEMPORAL-ANTECEDENT-RECALL.1 design commit>` (this `TEMPORAL-ANTECEDENT-RECALL.2` close commit pending → becomes 13 ahead of pushed `d92a73e3`; push at ~30). NOTE: workspace fully recompiled; CI green baseline = 1218 tests.
