...
- latest_commit_hash: `9991fce9a64cab15344ae90f8354bf662da1b049`
- latest_commit_brief_message: `test(rescan): lock finding-count improvement`
...
- objective:
  - add rescan-plan run-report coverage proving review-required summaries are counted by arbitration verdict suffix
  - refresh live docs for the report summary count behavior
- tracker effect:
  - planned live-status row addition: `specforge rescan-plan` run-report review-required count is regression-locked: `Done`
- verification status:
...
- current known local CI baseline:
  - `568` Rust tests plus warning-deny Clippy/rustdoc and mdBook validation
