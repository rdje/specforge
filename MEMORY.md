...
- the refreshed live baseline is now AXI `84/100 GOOD`, APB `94/100 EXCELLENT`, AHB `94/100 EXCELLENT`, and AXI-Stream `90/100 EXCELLENT`, with `0` residual decisions across all four tracked live artifacts; a fresh rebuild from current `SourceIR` / `EvidenceIR` restored APB and AHB to the excellent lane
...
- the tracked live validation baseline has now been refreshed against the current semantic/intent stack and is more honest than the old stale snapshot: AXI 84/100 GOOD, APB 94/100 EXCELLENT, AHB 94/100 EXCELLENT, AXI-Stream 90/100 EXCELLENT
