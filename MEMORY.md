...
- latest_commit_hash: `45371f157d6db60740d10f66b2f0f5a341a1bdc8`
- latest_commit_brief_message: `test(rescan): lock added-finding arbitration`
...
- objective:
  - add rescan-plan arbitration coverage proving score decreases alone produce regression review
  - refresh live docs for the isolated score-drop verdict behavior
- tracker effect:
  - planned live-status row addition: `specforge rescan-plan` score decreases force regression review: `Done`
- verification status:
...
- current known local CI baseline:
  - `564` Rust tests plus warning-deny Clippy/rustdoc and mdBook validation
