...
- completed_count: `.1`(`f557baba`) `.2`-split(`b92f29ef`) `.2.1`(`5be3b278`) IR-PRUNE.3-supersede(`3e3fe823`) `.2.2`(`0ccdc8f0` windowed temporal_rules→`(contract …)` live-verified) FSMGEN-ISSUE-REPORTING-tree(`1c3a5d37`) FSMGEN-ISSUE-REPORTING.1(committing now: F1 bundle `sf-isf-contract-eventually-flat` built+reproduced, submodule clean). Next frontier: `FSMGEN-ISSUE-REPORTING.2` (F2 stage-ready-valid bundle), then `.3` (feedback-doc refs + close), then resume `ISF-TEMPORAL-LOWERING.2.3`
