...
- latest_commit_hash: `ddb5a972fc4525e39a9999562df9dde22865ede0`
- latest_commit_brief_message: `test(rescan): lock score-drop arbitration`
...
- objective:
  - add rescan-plan arbitration coverage proving score increases alone produce possible-improvement review
  - refresh live docs for the isolated score-rise verdict behavior
- tracker effect:
  - planned live-status row addition: `specforge rescan-plan` score increases stay possible-improvement review: `Done`
- verification status:
...
- current known local CI baseline:
  - `565` Rust tests plus warning-deny Clippy/rustdoc and mdBook validation
