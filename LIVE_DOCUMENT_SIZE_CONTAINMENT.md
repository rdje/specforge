...
- Adoption state: `.3b` activated doctrine, ADR, complete registry, and checker atomically. `.3c`
  ...
  shorthand remains lossless without becoming an arbitrary alias mechanism. `.3.1` then performs the guarded
  ...
  ADR 0029 then re-derived that whole profile once, after ADR 0028 made every authority visible. Capacity was
