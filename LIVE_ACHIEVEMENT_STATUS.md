...
- Test suite expanded to 162 tests; all passing: Done
...
- Finish replacing the remaining direct `direction_hint` consumers with actor-relative graph semantics, then deepen semantic-role arbitration and richer multimodal grounding while continuing structural/temporal arbitration and KG-quality evaluation
