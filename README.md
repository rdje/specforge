...
- `specforge clean [--execute]` reclaims local generated artifacts; by default it dry-runs `generated/source_ir/*/normalized`, and `--scope document [--document-key <key>]` can remove full per-document generated stage trees when you intentionally want a cold rebuild
