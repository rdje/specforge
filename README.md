...
- the tracked KG fixture set now also tightens the VLM timing spurious-annotation negative case: compact sample labels like `D0`, `A1`, `DATA0`, and `0xAA` stay out of timing constraints just like `T0`, `Addr 1`, and `Cycle 2`
