...
- the canonical polarity surface is now stronger than the live corpus: the projected AMBA artifacts currently report `with_resolved_polarity: 0`, so the next real win there is improved polarity extraction coverage, not more schema work
